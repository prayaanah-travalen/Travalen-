...
class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:4200","http://localhost:5000","http://travalen.com.s3-website.ap-south-1.amazonaws.com","https://www.travalen.in","https://travalen.in","https://api.travalen.in")); //or add * to allow all origins
